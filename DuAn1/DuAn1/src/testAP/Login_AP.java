...
//		WebDriverManager.firefoxdriver().setup();
	...
	public void click_send_Web() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@class='whsOnd zHQkBf']")).sendKeys("baolnpps30114");
		...
		Thread.sleep(2000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@class='whsOnd zHQkBf']")));
		driver.findElement(By.xpath("//input[@class='whsOnd zHQkBf']")).sendKeys("lnpbao@1123");
	...
	@Test(priority = 3)
	public void click_close_Web() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("close")));
		WebElement driveEle5 = driver.findElement(By.className("close"));
		Actions actions5 = new Actions(driver).click(driveEle5);
