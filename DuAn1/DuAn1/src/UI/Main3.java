...
public class Main3 extends javax.swing.JDialog {

    public Main3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Quan Ly Cua Hang - YumFood");
//        jLabel7.setText(Auth.nv.getHoTen());
        color_TrangChu();
    }
    //100, 128
...
//    int h = 128;
    ...
    private void initComponents() {
        ...
        pnlDoanhThu2 = new UI.pnlDoanhThu();
        ...
        jTabbedPane1.addTab("tab3", pnlDoanhThu2);

        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -5, 1290, 690));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Main3 dialog = new Main3(new javax.swing.JFrame(), true);
    ...
    private UI.pnlDoanhThu pnlDoanhThu2;
